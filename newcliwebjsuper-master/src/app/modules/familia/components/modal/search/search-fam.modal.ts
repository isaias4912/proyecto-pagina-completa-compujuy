...
declare var $: any;
@Component({
  selector: 'search-fam-modal',
  templateUrl: './search-fam.modal.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class SearchFamModal extends Dialog implements AfterViewInit {
  ...
  selectFam(familia){
    this.activeModal.close(familia);
  }
}
