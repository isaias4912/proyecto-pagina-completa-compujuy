...
@RestController
@RequestMapping("public/v1/tipoPrecio")
public class TipoPreciosPublicController {

    @Autowired
    TipoPreciosService tipoPreciosService;

    @RequestMapping(value = "/all", method = RequestMethod.GET, produces = "application/json")
    public ResponseEntity<Object> getAll() throws BussinessException {
        return new ResponseEntity<Object>(tipoPreciosService.getAllActive(), HttpStatus.OK);
    }
