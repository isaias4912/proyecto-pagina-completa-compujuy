...
public class PagoCbteCompMinDTO implements Serializable {
	...
	private String tipo;
	private SimpleObjectDTO cbteCompEnc;

	public PagoCbteCompMinDTO() {
	}
	...
	public SimpleObjectDTO getCbteCompEnc() {
		return cbteCompEnc;
	}

	public void setCbteCompEnc(SimpleObjectDTO cbteCompEnc) {
