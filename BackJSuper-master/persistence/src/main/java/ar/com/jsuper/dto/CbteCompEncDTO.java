...
public class CbteCompEncDTO {
	...
	private Set<CbteCompDetDTO> items;
	private Set<PagoCbteCompDTO> pagos;

	public CbteCompEncDTO() {
	}
	...
	public Set<CbteCompDetDTO> getItems() {
		return items;
	}

	public void setItems(Set<CbteCompDetDTO> items) {
		this.items = items;
	}

	public Set<PagoCbteCompDTO> getPagos() {
		return pagos;
	}

	public void setPagos(Set<PagoCbteCompDTO> pagos) {
		this.pagos = pagos;
	}
