...
public class StockSucursalMinDTO extends ObjectDTO implements Serializable {
    ...
    private ProductoMinDTO productoDTO;
    private SucursalesDTO sucursal;

    public StockSucursalMinDTO() {
    }
    ...
    public ProductoMinDTO getProductoDTO() {
        return productoDTO;
    }

    public void setProductoDTO(ProductoMinDTO productoDTO) {
