...
public class MovimientosCtaCteDTO implements Serializable {
	...
	private PagosCtaCteDTO pagoCtaCte;

	public MovimientosCtaCteDTO() {
	}
	...
	public PagosCtaCteDTO getPagoCtaCte() {
		return pagoCtaCte;
	}

	public void setPagoCtaCte(PagosCtaCteDTO pagoCtaCte) {
