...
public class CbteEncDTO {
    ...
    private App app;
    private SimpleObjectDTO cliente;
    private UsuariosNanoDTO usuario;
    private List<CbteVenDetSinEncabDTO> detalleVentas;
    ...
    public SimpleObjectDTO getCliente() {
        return cliente;
    }

    public void setCliente(SimpleObjectDTO cliente) {
    ...
    public List<CbteVenDetSinEncabDTO> getDetalleVentas() {
        return detalleVentas;
    }

    public void setDetalleVentas(List<CbteVenDetSinEncabDTO> detalleVentas) {
